...
export const excludeRoutes = [
  ...
  {
    path: 'api/gateway_product/dashboard-products',
  ...
  {
    path: 'api/gateway_product/get-product-and-reviews-count',
    method: RequestMethod.GET,
  },
  { path: 'api/tools/country-states', method: RequestMethod.GET },
  { path: 'api/gateway_product/get-top-ratings', method: RequestMethod.GET },
  {
    path: 'api/gateway_product/product-category-list',
    method: RequestMethod.POST,
  },
  {
    path: 'api/gateway_product/product-review-list',
    method: RequestMethod.POST,
  },
  ...
  {
    path: 'api/gateway_product/rmq-get-product-details',
    method: RequestMethod.POST,
  },
  {
    path: 'api/gateway_product/rmq-get-products-list',
    method: RequestMethod.POST,
  },
