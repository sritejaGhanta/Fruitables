...
@Injectable()
export class CartItemDetailsService extends BaseService {
  
  
  protected readonly log = new LoggerHandler(
    CartItemDetailsService.name,
  ).getInstance();
  ...
  /**
   * startCartItemDetails method is used to initiate api execution flow.
   * @param array reqObject object is used for input request.
   * @param array reqParams array is used for input params.
   * @param array reqFiles array is used for post files.
   * @return array outputResponse returns output response of API.
   */
  async startCartItemDetails(reqObject, reqParams) {
    let outputResponse = {};
    ...
    try {
      ...
      this.log.error('API Error >> cart_item_details >>', err);
    }
  ...
  cartItemDetailsFinishSuccess(inputParams: any) {
    ...
    const funcData: any = {};
    funcData.name = 'cart_item_details';
