...
export class GatewayUserController {
  ...
  async rmqGetUsersList(@Payload() body) {
    ...
    return await this.rmqGetUsersListService.startRmqGetUsersList(request, params);
  }
  ...
  async rmqUserOtpUpdate(@Payload() body) {
    ...
    return await this.rmqUserOtpUpdateService.startRmqUserOtpUpdate(request, params);
  }
