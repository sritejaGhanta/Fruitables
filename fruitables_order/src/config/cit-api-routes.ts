const routes = {
    'post': { 
        ...
        'api/gateway_order/cancel-order/:id': 'cancel_order',
        ...
        'api/gateway_order/order-add': 'order_add',
        'api/gateway_order/order-details/:id': 'order_details',
        'api/gateway_order/order-list': 'order_list',
    ...
    'get': { 
        ...
        'api/gateway_order/get-bestseller-products': 'get_bestseller_products',
        ...
        'api/auth/menu': 'menu',
        'api/gateway_order/rmq-order-detail': 'rmq_order_detail',
